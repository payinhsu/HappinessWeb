...
export default class Document extends React.Component {
  ...
  signatureComplete(contentType, file) {
    return function(signature) {
      ...
      var fileName = signature.contentDisposition;
  ...
  render() {
    ...
    return (
      <span>
        <Button type="button" onClick={this.handleBtnClick}>{this.props.btnName !== undefined ? this.props.btnName : Document.docTypes[this.props.docType].btnName}</Button>
